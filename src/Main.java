...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // Поток, отвечающий за поиск строки с самым большим количеством символов 'a'
        new Thread(() -> {
            workOfThread('a', arrayBlockingQueueA);
        }).start();

        // Поток, отвечающий за поиск строки с самым большим количеством символов 'b'
        new Thread(() -> {
            workOfThread('b', arrayBlockingQueueB);
        }).start();

        // Поток, отвечающий за поиск строки с самым большим количеством символов 'c'
        new Thread(() -> {
